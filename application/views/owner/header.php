                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="<?php echo base_url()  ?>owner/profile" class="btn btn-default btn-flat">Profile</a>
                                </div>
                                <div class="pull-right">
                                    <a href="<?php echo base_url()  ?>owner/logout" class="btn btn-default btn-flat">Sign out</a>
                                </div>
                            </li>
                        </ul>
                    </li>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li><a href="<?php echo base_url()  ?>owner/dashboard/"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
                <li><a href="<?php echo base_url()  ?>owner/products/"><i class="fa fa-product-hunt"></i> <span>Products</span></a></li>
                <li ><a href="<?php echo base_url()  ?>owner/product-orders/"><i class="fa fa-shopping-cart"></i> <span>Product Orders</span></a></li>
                <li ><a href="<?php echo base_url()  ?>owner/view-orders/"><i class="fa fa-cart-plus"></i> <span>View Orders</span></a></li>
                <li ><a href="<?php echo base_url()  ?>owner/tickets/"><i class="fa fa-ticket"></i> <span>Ticketing System</span></a></li>
