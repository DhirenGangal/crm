    ...
    <section class="content">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                ...
                <div class="box-tools">
                    <a href="<?php echo base_url(); ?>owner/tickets/add" class="btn btn-info"><i class="fa fa-plus"></i> Add Ticket</a>
                </div>
                            ...
                            <tr>
                                ...
                                <td class="">
                                    ...
                                    <a data-toggle="tooltip" data-placement="bottom"
                                       href="<?php echo base_url() ?>owner/tickets/edit/<?php echo $ticket['ticket_id']; ?>"
                                       title='Edit' class="btn btn-sm btn-default"><i class="fa fa-pencil text-info"></i></a>
                                    <a data-toggle="tooltip" data-placement="bottom"
                                       href="<?php echo base_url() ?>owner/tickets/?act=del&ticket_id=<?php echo $ticket['ticket_id']; ?>"
