        ...
        <div class="box box-info">
            <div class="box-header with-border hidden-print">
                <div class="form-group text-center">
                    ...
                    <label class="radio-inline"><input type="radio" class="radio" name="print_type" value="customer" checked>Customer</label>
                ...
                <div class="box-tools">
                    ...
                    <a href="<?php echo base_url() ?>owner/orders/print/<?php echo $order['order_id'] ?>?type=customer" class="btn btn-sm btn-success ptype" target="_blank"><i class="fa fa-print"></i> Print</a>
                </div>
            </div>
            <div class="box-body">
                <div class="row">
...
<script>
    $(document).ready(function () {
        ...
        $('.radio').change(function () {
            var val = $(this).val();
            console.log(val);
            $('.ptype').attr("href", "<?php echo base_url() ?>owner/orders/print/<?php echo $order['order_id'] ?>?type=" + val);
            if (val == 'customer') {
