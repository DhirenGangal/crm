...
include_once(rtrim(APPPATH, "/") . "/third_party/dompdf/autoload.inc.php");
                ...
                <div class="col-md-12 p-t-20">
                    <table class="table table-bordered product_table" id="dynamic_field">
                        ...
                        <tr>
                            ...
                            <th colspan="1" rowspan="2" class="text-right w-10">Taxable Value ( <i
                                        class="fa fa-inr"></i> )
                            </th>
                            <?php
                            if (($order["order_items"][0]["cgst_amount"] != "0.00")) {
                                ?>
                                <th colspan="1" rowspan="1" class="text-center w-10">CGST ( <i class="fa fa-inr"></i> )
                                </th>
                                <th colspan="1" rowspan="1" class="text-center w-10">SGST ( <i class="fa fa-inr"></i> )
                                </th>
                                <?php
                            }
                            ?>
                            ...
                            if (($order["order_items"][0]["igst_amount"] != "0.00")) {
                                ?>
                                <th colspan="1" rowspan="1" class="text-center w-10">IGST ( <i class="fa fa-inr"></i> )
                                </th>
                                <?php
                            }
                            ?>
                            <th colspan="1" rowspan="2" class="text-center w-10">Total ( <i class="fa fa-inr"></i> )
                            </th>
                        </tr>
                        </thead>
                        <tbody>
