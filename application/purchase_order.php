...
<section class="content">
    ...
    <div class="box box-info">
        <div class="box-body">
            <div class="row">
                <p>Subject: Your VSCIE order confirmation</p>
                Dear Raghu Dandu,

                Thank you for your order. Below are the order detail based upon PO number : ORD-6317
                ...
                <div class="col-md-12" style="width: 100%; float: right; text-align: right">
                    <b>Total Amount (In words)</b>: <?php echo !empty($order['text_amount']) ? $order['text_amount'] : 0.00; ?>
                </div>
                <div class="col-md-12">
                    Need to make any changes? Contact us at orders@vscietechnologies.com. For any technical assistance
                    contact +91 9620132023. Visit us at http://www.vscietechnologies.com
                </div>
                <div class="col-md-12">
                    We hope to see you again.
                    Team VSCIE Technologies
                </div>
            </div>
        </div>
    </div>
