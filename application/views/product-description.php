...
<div id="product" class="section-container p-t-20 bg-silver">
    ...
    <div class="container">
        ...
        <ul class="breadcrumb m-b-10 f-s-12">
            ...
            <li><a href="<?=base_url('products/'.$product['mp_product_id'])?>"><?=$product['mp_product_name']?></a></li>
            <li><a href="<?=base_url('products/'.$product['mp_product_id'].'/'.$product['sp_product_id'])?>"><?=$product['sp_product_name']?></a></li>
                ...
                <div class="product-image">
                    ...
                    <div class="product-thumbnail">
                        <ul class="product-thumbnail-list">
                            <li class="active"><a href="#" data-click="show-main-image" data-url="<?=base_url('assets/img/iphone-6s-plus-2.jpg')?>"><img src="<?=base_url('assets/img/iphone-6s-plus-2.jpg')?>" alt="" /></a></li>
                            <li><a href="#" data-click="show-main-image" data-url="<?=base_url('assets/img/iphone-6s-plus-3.jpg')?>"><img src="<?=base_url('assets/img/iphone-6s-plus-3.jpg')?>" alt="" /></a></li>
                            <li><a href="#" data-click="show-main-image" data-url="<?=base_url('assets/img/iphone-6s-plus-4.jpg')?>"><img src="<?=base_url('assets/img/iphone-6s-plus-4.jpg')?>" alt="" /></a></li>
                            <li><a href="#" data-click="show-main-image" data-url="<?=base_url('assets/img/iphone-6s-plus-5.jpg')?>"><img src="<?=base_url('assets/img/iphone-6s-plus-5.jpg')?>" alt="" /></a></li>
                            <li><a href="#" data-click="show-main-image" data-url="<?=base_url('assets/img/iphone-6s-plus-6.jpg')?>"><img src="<?=base_url('assets/img/iphone-6s-plus-6.jpg')?>" alt="" /></a></li>
                            <li><a href="#" data-click="show-main-image" data-url="<?=base_url('assets/img/iphone-6s-plus-7.jpg')?>"><img src="<?=base_url('assets/img/iphone-6s-plus-7.jpg')?>" alt="" /></a></li>
                        </ul>
                    </div>
                    <!-- END product-thumbnail -->
                    <!-- BEGIN product-main-image -->
                    <div class="product-main-image" data-id="main-image">
                        <img src="<?=base_url('assets/img/iphone-6s-plus.png')?>" alt="" />
                    </div>
                ...
                <div class="product-info">
                    ...
                    <div class="product-info-header">
                        <h1 class="product-title">
                            ...
                            <?php }?>
                            <?=$product['product_name']?> <?=!empty($product['hsn_code']) ? ' - #'. $product['hsn_code'] : '' ?> </h1>
                        <ul class="product-category">
                            <li>Manufacturer : <?=$product['mfr_no']?></li>
                            <!-- <li>/</li>
                            <li>Manufacturer : <?//=$product['mfr_no']?></li> -->
                    ...
                    <ul class="product-info-list">
                        <li><i class="fa fa-circle"></i> <?=$product['description_1']?></li>
                        <li><i class="fa fa-circle"></i> Parent Product Of <?=$product['mp_product_name']?></li>
                        <li><i class="fa fa-circle"></i> Sub Product Of <?=$product['sp_product_name']?></li>
                        <li><i class="fa fa-circle"></i> MAC ID : <?=$product['has_mac_id']== '1' ? 'Yes' : 'No'?></li>
                        ...
                        <li><i class="fa fa-circle"></i> HSN Code : <?=$product['hsn_code']?></li>
                        <li><i class="fa fa-circle"></i> HSN Description : <?=$product['hsn_description']?></li>
                    </ul>
                    ...
                    <div class="product-purchase-container">
                        <?php if($product['discount'] > 0) {?>
                            <div class="product-discount">
                                <span class="discount"><i class="fa fa-inr"></i>
                                <?php 
                        ...
                        <div class="product-price">
                            <div class="price"><i class="fa fa-inr"></i><?=number_format($product['mrp_price'],2)?></div>
                        </div>
                ...
                <div id="product-tab-content" class="tab-content">
                    ...
                    <div class="tab-pane fade active in" id="product-desc">
                        ...
                        <div class="product-desc">
                            <div class="image">
                                <img src="<?=base_url('assets/img/product-main.jpg')?>" alt="" />
                            </div>
                            <div class="desc">
                                <h4>iPhone 6s</h4>
                                <p>
                        ...
                        <div class="product-desc right">
                            <div class="image">
                                <img src="<?=base_url('assets/img/product-3dtouch.jpg')?>" alt="" />
                            </div>
                            <div class="desc">
                                <h4>3D Touch</h4>
                                <p>
                        ...
                        <div class="product-desc">
                            <div class="image">
                                <img src="<?=base_url('assets/img/product-cameras.jpg')?>" alt="" />
                            </div>
                            <div class="desc">
                                <h4>Cameras</h4>
                                <p>
                        ...
                        <div class="product-desc right">
                            <div class="image">
                                <img src="<?=base_url('assets/img/product-technology.jpg')?>" alt="" />
                            </div>
                            <div class="desc">
                                <h4>Technology</h4>
                                <p>
                        ...
                        <div class="product-desc">
                            <div class="image">
                                <img src="<?=base_url('assets/img/product-design.jpg')?>" alt="" />
                            </div>
                            <div class="desc">
                                <h4>Design</h4>
                                <p>
                            ...
                            <div class="col-md-7">
                                ...
                                <div class="review">
                                    <div class="review-info">
                                        <div class="review-icon"><img src="<?=base_url('assets/img/user-1.jpg')?>" alt="" /></div>
                                ...
                                <div class="review">
                                    <div class="review-info">
                                        <div class="review-icon"><img src="<?=base_url('assets/img/user-2.jpg')?>" alt="" /></div>
                                        <div class="review-rate">
                                            <ul class="review-star">
                                                <li class="active"><i class="fa fa-star"></i></li>
                                                <li class="active"><i class="fa fa-star"></i></li>
                                ...
                                <div class="review">
                                    <div class="review-info">
                                        <div class="review-icon"><img src="<?=base_url('assets/img/user-3.jpg')?>" alt="" /></div>
                                        <div class="review-rate">
                                            <ul class="review-star">
                                                <li class="active"><i class="fa fa-star"></i></li>
                                                <li class="active"><i class="fa fa-star"></i></li>
                                ...
                                <div class="review">
                                    <div class="review-info">
                                        <div class="review-icon"><img src="<?=base_url('assets/img/user-4.jpg')?>" alt="" /></div>
                                        <div class="review-rate">
                                            <ul class="review-star">
                                                <li class="active"><i class="fa fa-star"></i></li>
                                                <li class="active"><i class="fa fa-star"></i></li>
                                ...
                                <div class="review">
                                    <div class="review-info">
                                        <div class="review-icon"><img src="<?=base_url('assets/img/user-5.jpg')?>" alt="" /></div>
                                        <div class="review-rate">
                                            <ul class="review-star">
                                                <li class="active"><i class="fa fa-star"></i></li>
                                                <li class="active"><i class="fa fa-star"></i></li>
        ...
        <div class="row row-space-10">
            <div class="col-md-2 col-sm-4">
                ...
                <div class="item item-thumbnail">
                    <a href="product_detail.html" class="item-image">
                        <img src="<?=base_url('assets/img/iphone.png')?>" alt="">
            ...
            <div class="col-md-2 col-sm-4">
                ...
                <div class="item item-thumbnail">
                    <a href="product_detail.html" class="item-image">
                        <img src="<?=base_url('assets/img/samsung-note5.png')?>" alt="">
            ...
            <div class="col-md-2 col-sm-4">
                ...
                <div class="item item-thumbnail">
                    <a href="product_detail.html" class="item-image">
                        <img src="<?=base_url('assets/img/iphone-se.png')?>" alt="">
            ...
            <div class="col-md-2 col-sm-4">
                ...
                <div class="item item-thumbnail">
                    <a href="product_detail.html" class="item-image">
                        <img src="<?=base_url('assets/img/zenfone2.png')?>" alt="">
                        <div class="discount">15% OFF</div>
                    </a>
                    <div class="item-info">
                        <h4 class="item-title">
            ...
            <div class="col-md-2 col-sm-4">
                ...
                <div class="item item-thumbnail">
                    <a href="product_detail.html" class="item-image">
                        <img src="<?=base_url('assets/img/xperia-z.png')?>" alt="">
                        <div class="discount">32% OFF</div>
                    </a>
                    <div class="item-info">
                        <h4 class="item-title">
            ...
            <div class="col-md-2 col-sm-4">
                ...
                <div class="item item-thumbnail">
                    <a href="product_detail.html" class="item-image">
                        <img src="<?=base_url('assets/img/lumia-532.png')?>" alt="">
                        <div class="discount">20% OFF</div>
                    </a>
                    <div class="item-info">
                        <h4 class="item-title">
