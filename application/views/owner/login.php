            ...
            <div class="login-box-body">
                ...
                <form id="loginForm"  method="post">
                    ...
                    <div class="form-group has-feedback">
                        <input type="email" name="email" id="email" class="form-control" placeholder="Email" autofocus="autofocus">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4">
                          <!--  <a href="<?php /*echo base_url()  */?>owner/dashboard" role="button" class="btn btn-primary btn-block">Sign In</a>-->
                ...
                <div class="social-auth-links text-center">
                    <p>- OR -</p>
                    <a href="<?php echo base_url() ?>owner/forgot-password">I forgot my password</a><br>
                    <a href="<?php echo base_url(); ?>owner/register" class="text-center">Register a new membership</a>
                </div>
            </div>
        </div>
