                        ...
                        <table class="table table-bordered product_table" id="dynamic_field">
                            ...
                            if(!empty($order['order_items'])){
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" class="form-control dealer_price" name="dealer_price[]" value="<?php echo !empty($order_item['unit_price'])? $order_item['unit_price'] : '' ?>"/></td>
                                    <td><input type="text" class="form-control qty" name="quantity[]" value="<?php echo !empty($order_item['quantity'])? $order_item['quantity'] : '' ?>"/></td>
                                    <td><input type="text" class="form-control discount_value" name="discount_amount[]" value="<?php echo !empty($order_item['discount'])? $order_item['discount'] : '' ?>"/></td>
                                    <td><input type="text" class="form-control input_amount" name="item_amount[]" value="<?php echo !empty($order_item['total_amount'])? $order_item['total_amount'] : '' ?>"/></td>
                                    <td class="">
    ...
    $(document).ready(function () {
        ...
        $('#add').click(function () {
            ...
            var row = '<tr>' +
                ...
                '</select>' +
                '</td>' +
                '<td><input type="text" class="form-control dealer_price" name="dealer_price[]" /></td>' +
                '<td><input type="text" class="form-control qty" name="quantity[]" /></td>' +
                '<td><input type="text" class="form-control discount_value" name="discount_amount[]" value="<?php echo !empty($order['discount'])? $order['discount'] : '' ?>"/></td>' +
                '<td><input type="text" class="form-control input_amount" name="item_amount[]" /></td>' +
