                ...
                <div class="box-body">
                    <table class="table table-bordered data-table table-hover">
                        ...
                        <tr>
                            ...
                            <th class="w-10 text-center">HSN/SAC</th>
                            <th class="w-15 text-center"> Name</th>
                            <th class="text-center">Description</th>
                            <th class="w-10 text-center">Datasheet</th>
                            <th class="w-10 text-center">Pricing(INR)</th>
                            <th class="w-10 text-center">Discount(%)</th>
                                                    ...
                                                    foreach ($child_product['product_details'] as $info) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    ...
                                                                    ?>
                                                                    <a class="without-caption" title="<?php echo $info['child_product_name']; ?>" href="<?php echo !empty($img) ? base_url() . $img : dummyLogo() ?>">
                                                                        <img src="<?php echo !empty($img) ? base_url() . $img : dummyLogo() ?>" alt="product image" class="p-img">
                                                                    </a>
                                                                </td>
                                                                <td class="text-center"><?php echo $info['hsn_code']; ?></td>
                                                                <td class="text-center"><?php echo $info['child_product_name']; ?></td>
                                                                ...
                                                                <td class="text-center">
                                                                    ...
                                                                    <?php echo !empty($info['discount']) ? $info['discount'] . ' ' . '%' : '0' . ' ' . '%'; ?>
                                                                </td>
                                                                <td class="text-center">
