        ...
        <nav class="navbar navbar-static-top">
            <div class="container">
                <div class="navbar-header">
                    <a href="<?php echo base_url() ?>dealer/dashboard" class="navbar-brand"> <span class="logo-lg"><b><?php echo !empty($site_title) ? $site_title : ''; ?></b></span></a>
                ...
                <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="<?php echo base_url() ?>dealer/products">Products <span class="sr-only">(current)</span></a></li>
                        <li><a href="<?php echo base_url() ?>dealer/orders/">Product Orders</a></li>
                        <li><a href="<?php echo base_url() ?>dealer/view-users">View Users</a></li>
                        <li><a href="<?php echo base_url() ?>dealer/tickets">Ticketing System</a></li>
                    </ul>
                </div>
                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav ">
                        <li class="dropdown notifications-menu cart-data" data-user="<?php echo $_SESSION['USER_ID'] ?>">
                            <!-- Menu toggle button -->
                                ...
                                if(!empty($cart_items)){
                                            ...
                                            if (!empty($cart_items)) {
                                                foreach ($cart_items as $cart_item) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a data-toggle="tooltip" data-placement="bottom" href="<?php echo base_url() ?>dealer/add_cart_info/?act=del&pk_id=<?php echo $cart_item['pk_id']; ?>" title='Delete' onclick="return window.confirm('Do You Want to Delete?');" class="btn btn-sm btn-default"><i class="fa fa-trash text-danger"></i></a></td>
                                                    </tr>
                                                    <?php
                                                }
                                            }
                                    ...
                                    <li class="footer">
                                        <ul class="list-inline list-unstyled text-center">
                                            <li><a class="btn btn-sm btn-primary" href="<?php echo base_url() ?>dealer/view-cart">View all</a></li>
                                            <li><a class="btn btn-sm btn-danger clear-cart"  href="<?php echo base_url() ?>dealer/clear_cart/?created_by=<?php echo $_SESSION['USER_ID'] ?>">ClearCart</a></li>
                                        </ul>
                                    </li>
                                <?php
                                }else{
                                    ?>
                                    <li class="header text-center">You have <?php echo !empty($cart_items) ? count($cart_items) : '0' ?> items in cart
                                    </li>
                                <?php
                                }
                                ?>
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                ?>
                                <img src="<?php echo base_url(); ?><?php echo !empty($img) ? $img :'assets/images/avatar.jpeg' ?>" class="user-image">
                                <span class="hidden-xs"> <?php echo !empty($user_data['first_name']) ? $user_data['first_name'] : 'SCIE Technologies' ?></span>
                            </a>
                            <ul class="dropdown-menu">
                                <li class="user-header text-center">
                                    <img src="<?php echo base_url(); ?><?php echo !empty($img) ? $img :'assets/images/avatar.jpeg' ?>" class="img-circle" alt="User Image">
                                ...
                                <li class="user-footer">
                                    ...
                                    <div class="pull-right">
                                        <a href="<?php echo base_url() ?>dealer/logout" class="btn btn-default btn-flat">Logout</a>
                                    </div>
                                </li>
                            </ul>
                        </li>
