            ...
            <form class="form-horizontal" method="post" id="frm">
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-6">
                            <div class="form-group has-feedback">
                                <label class="control-label col-md-4">Account Name <sup class="text-danger">*</sup>
                                    :</label>
                                <div class="col-md-8">
                                    <input type="text" name="account_name" class="form-control" required data-validation="alphanumeric"
                        ...
                        <div class="col-md-6">
                            <div class="form-group has-feedback">
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="date_installed" class="form-control" placeholder="Installed Date" id="datepicker">
                        ...
                        <div class="col-md-6">
                            <div class="form-group has-feedback">
                                <label class="control-label col-md-4">Mac Id : <sup class="text-danger">*</sup></label>
                                <div class="col-md-8">
                                    <input type="text" name="mac_id" id="mac_id" class="form-control mac_id" maxlength="12" placeholder="Mac Id" required>
                                    <input type="hidden" name="dealer_id" id="dealer_id" class="form-control" value="">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-6" id="pwd-container">
                            <div class="form-group has-feedback">
                                <label class="control-label col-md-4">Password <sup class="text-danger">*</sup>
                                    :</label>
                                <div class="col-md-8">
                                    <input type="password" class="form-control" name="password" id="password" required
                                           placeholder="Password">
                                    <span id="eye" style="display:none" data-click-state="1"
                        ...
                        <div class="col-md-6">
                            <div class="form-group has-feedback">
                                <label class="control-label col-md-4">Zone : <sup class="text-danger">*</sup></label>
                                <div class="col-md-8">
                    ...
                    <div class="col-md-offset-1 col-md-11">
                        ...
                        <div class="checkbox">
                            <label><input name="f1" type="checkbox" required data-validation="required"
                                        ...
                                        class="text-danger"> * </sup> I have read and accept the above Terms of
                                Use.</label>
                        </div>
                        <div class="checkbox">
                            <label><input name="f1" type="checkbox" value="" data-validation="required"
                                        ...
                                        class="text-danger"> * </sup> I have read and accept the <a href="#"
                                                                                                    class="privacy"
                                                                                                    data-toggle="modal"
                                                                                                    data-target="#myModal">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-xs-4">
                            <button type="submit" class="btn btn-success btn-block btn-flat btn-submit">Register</button>
                        </div>
                    </div>
                </div>
    ...
    $(document).ready(function () {
        ...
        $("#mac_id").change(function () {
            ...
            if (mac_id.length == 12) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url() ?>owner/check_mac_id",
                    data: {mac_id: mac_id},
                    success: function (data) {
                        if (data == 'OK') {
                            msgbox1.html('<span class="text-danger"> Mac id is  incorrect </span>');
                            $('.btn-submit').attr('disabled',true);
                            console.log('Mac Id Incorrect--- Disabled');
                        }
                        else {
                            msgbox1.html(data);
                         //   $('.btn-submit').attr('disabled','false');
                            $('.btn-submit').attr('disabled',false);
                            console.log('Mac Id  Correct--Enable');
                        }
                    }
                });
        ...
        $('.mac_id').on('focusout', function () {
            var mac_id = $(this).val();
            $.ajax({
                type: "POST",
                url: "<?php echo base_url() ?>" + "owner/getMacDetails",
                data: {mac_id: mac_id},
                dataType:'json',
                cache : false,
                success: function (data) {
