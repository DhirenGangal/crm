    ...
    <section class="content">
        ...
        <div class="box box-info">
            <div class="box-header with-border hidden-print">
                ...
                <div class="box-tools">
                    <a href="<?php echo base_url() ?>admin/orders/" class="btn btn-danger " ><i class="fa fa-arrow-left"></i> Back</a>
                    <a href="<?php echo base_url() ?>admin/orders/download/<?php echo $order['order_id'] ?>" class="btn btn-primary" target="_blank"><i class="fa fa-download"></i> Download</a>
                    <a href="<?php echo base_url() ?>admin/orders/print/<?php echo $order['order_id'] ?>?type=customer" class="btn btn-success ptype" target="_blank"><i class="fa fa-print"></i> Print</a>
                </div>
            </div>
            <div class="box-body">
                <div class="row">
...
<script>
    $(document).ready(function () {
        ...
        $('.radio').change(function () {
            var val = $(this).val();
            console.log(val);
            $('.ptype').attr("href", "<?php echo base_url() ?>admin/orders/print/<?php echo $order['order_id'] ?>?type=" + val);
            if (val == 'customer') {
