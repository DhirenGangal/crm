        ...
        <section class="content">
            ...
            <div class="box box-info">
                <div class="box-header with-border"><h3 class="box-title">Add Ticket System</h3>
                    <div class="box-tools">
                        <a href="<?php echo base_url(); ?>admin/tickets/" class="btn btn-danger"><i
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <textarea rows="5" class="form-control" readonly name="dealer_description"><?php echo !empty($ticket['dealer_description']) ? $ticket['dealer_description'] : ''; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3">Admin Description</label>
                                        <div class="col-md-8">
                                            <textarea rows="5" class="form-control" name="admin_description"><?php echo !empty($ticket['admin_description']) ? $ticket['admin_description'] : ''; ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="box-footer">
                    <div class="pull-right">
                        ...
                        <a href="<?php echo base_url() ?>admin/tickets/" class="btn btn-danger">Cancel</a>
                    </div>
                </div>
            </div>
        </section>
