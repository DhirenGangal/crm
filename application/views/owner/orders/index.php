            ...
            <div class="box box-info">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools hide">
                        <a href="<?php echo base_url(); ?>owner/orders/add" class="btn btn-info"><i class="fa fa-plus"></i> Add Order</a>
                    </div>
                </div>
                <div class="box-body">
                        ...
                        <?php if (!empty($orders)) {
                            ...
                            foreach ($orders as $order) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a data-toggle="tooltip" data-placement="bottom" href="<?php echo base_url() ?>owner/orders/po/<?php echo $order['order_id']; ?>" title='PO'
                                           class="btn btn-sm btn-warning"><i class="fa fa-bars "></i></a>
                                        <!--<a data-toggle="tooltip" data-placement="bottom"
                                           href="<?php /*echo base_url() */?>owner/orders/edit/<?php /*echo $order['order_id']; */?>"
                                           title='Edit' class="btn btn-sm btn-primary"><i class="fa fa-pencil "></i></a>-->
                                        <a data-toggle="tooltip" data-placement="bottom" href="<?php echo base_url() ?>owner/orders/preview/<?php echo $order['order_id']; ?>" title='Print'
                                           class="btn btn-sm btn-success"><i class="fa fa-print "></i></a>
                                        <!--<a data-toggle="tooltip" data-placement="bottom"
                                           href="<?php /*echo base_url() */?>owner/orders/?act=del&order_id=<?php /*echo $order['order_id']; */?>"
