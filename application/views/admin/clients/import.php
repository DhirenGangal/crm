<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-info">
            <div class="box-header with-border"><h3 class="box-title">Import Clients</h3>
                <div class="box-tools">
                    <a href="<?php echo base_url(); ?>import/clients-sample-csv/" class="btn btn-sm btn-primary"><i class="fa fa-download"></i> Download Sample CSV</a>
                    <a href="<?php echo base_url(); ?>admin/clients/" class="btn btn-sm btn-danger"><i class="fa fa-arrow-left"></i> Back</a>
                </div>
            </div>
            <div class="box-body">
