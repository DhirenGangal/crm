                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <input type="hidden" class="form-control ofc_state" name="state"
                                       value="<?php echo !empty($user['ofc_state']) ? $user['ofc_state'] : ''; ?>">
                                ...
                                <input type="hidden" class="form-control" name="dealer_id"
                                       value="<?php echo !empty($user['dealer_id']) ? $user['dealer_id'] : ''; ?>">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <input type="hidden" class="form-control" name="order_no" id="order_no" placeholder="Order NO" value="<?php echo !empty($sequence['sequence']) ? $sequence['sequence'] : ''; ?>" required><br/>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="hidden" class="form-control" name="delivery_within"
                            ...
                            <table class="table table-bordered cart_table" id="cart">
                                ...
                                if (!empty($cart_items)) {
                                    ...
                                    foreach ($cart_items as $cart_item) {
                                        ...
                                        $sgst = 0;
                                        $igst = 0;
                                        if ($_SESSION['STATE'] == $user['ofc_state']) {
                                            $cgst = $calc_amount / 2;
                                            $sgst = $calc_amount / 2;
                                            $final_total_withGst = ($sub_total) + ($calc_amount);
                                            echo $final_total_withGst;
                                        } else {
                                            $igst = $calc_amount;
                                            $final_total_withGst = $sub_total + $calc_amount;
                                        }
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right"><input type="hidden" class="mrp_price"
                                                                          name="mrp_price[]"
                                            ...
                                            <td class="text-right"><input type="hidden" class="input_gst" name="gst[]"
                                                                          value="<?php echo !empty($cart_item['gst']) ? $cart_item['gst'] : ''; ?>">
                                            ...
                                            <td class="text-right"><input type="hidden" name="input_sgst[]"
                                                                          value="<?php echo $sgst; ?>">
                                                <span class="sgst"><?php echo number_format($sgst, 2); ?></span>

                                            </td>
                                            <td class="text-right"><input type="hidden" name="input_igst[]"
                                                                          value="<?php echo $igst; ?>">
                                                <span class="igst"><?php echo number_format($igst, 2); ?></span></td>
                                            <td class="text-right"><input type="hidden" class="input_item_amount"
                                                                          name="sub_total[]"
                                                                          value="<?php echo !empty($final_total_withGst) ? $final_total_withGst : ''; ?>">
...
<script>
    $(document).ready(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data == 'false') {
                    ...
                    $('.order_no_status').html('Order No already Exists..!<br/> Please Contact Dealer,..!').css('color','red');
        ...
        $(".cart_table tbody tr").each(function () {
            amount = $(this).find('.item_amount').text();
