        ...
        <section class="content">
            ...
            <div class="box box-info">
                <div class="box-header with-border hidden-print">
                    ...
                    <div class="box-tools">
                        <a href="<?php echo base_url() ?>dealer/orders" class="btn btn-sm btn-danger"><i class="fa fa-arrow-left"></i> Back</a>
                        <a href="<?php echo base_url() ?>dealer/orders/print/1?type=customer" class="btn btn-sm btn-success ptype" target="_blank"><i class="fa fa-print"></i> Print</a>
                    </div>
                </div>
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-12  p-t-b-20">
                            ...
                            <div class="col-md-3  owner-info-2">
                                <ul class="list-unstyled">
                                    ...
                                    <br/>
                                    <li><span class="pull-left"><b>Approved By</b></span><span class="pull-right"><?php echo !empty($order['approved_by_name']) ? $order['approved_by_name'] : '' ?></span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 ">
                            ...
                            <div class="col-md-6 w-50"><b>Total Amount (In words)</b>
                                : <?php echo !empty($order['text_amount']) ? $order['text_amount'] : 0.00; ?>  </div>
                        </div>
                    </div>
                </div>
        </section>
...
<script>
    $(document).ready(function () {
        ...
        $('.radio').change(function () {
            var val = $(this).val();
            console.log(val);
            $('.ptype').attr("href", "<?php echo base_url() ?>dealer/orders/print/<?php echo $order['order_id'] ?>?type=" + val);
            if (val == 'customer') {
