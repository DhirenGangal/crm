           ...
           <p><?php echo getMessage()?></p>
            <div class="login-box-body">
                <div class="login-logo">
                    <a href="<?php echo base_url(); ?>admin/"><b><?php echo !empty($title) ? $title : '' ?></b></a>
                </div>
                ...
                <form id="loginForm"  method="post">
                    ...
                    <div class="form-group has-feedback">
                        <input type="email" name="email" id="email" class="form-control" placeholder="Email" autofocus="autofocus" required>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4">
                            <!--  <a href="<?php echo base_url()  ?>admin/dashboard" role="button" class="btn btn-primary btn-block">Sign In</a>-->
